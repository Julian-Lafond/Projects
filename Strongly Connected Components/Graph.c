...
Graph newGraph(int n)
{
	...
	create_graph->discover = malloc((n+1)*sizeof(int));
	create_graph->parent = malloc((n+1)*sizeof(int));
	create_graph->color = malloc((n+1)*sizeof(int));
	create_graph->finish = malloc((n+1)*sizeof(int));
	for (int i = 1; i < n + 1; i++)
	{
